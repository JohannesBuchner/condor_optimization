...
//  friend class XMLNode;
  protected:
    typedef struct // to allow shallow copy and "intelligent" pointers (automatic delete):
    {
  ...
  public:
    ...
    // create your first instance of XMLNode with these 2 parse functions:
    static XMLNode parseString(LPTSTR lpszXML, XMLResults *pResults=NULL);
    static XMLNode parseFile  (LPTSTR lpszXML, XMLResults *pResults=NULL);
